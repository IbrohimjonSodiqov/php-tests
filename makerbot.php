...
/*Bu kod @karimovs_a tomonidan yozib 
chiqildi va @sfg_uzbekistan kanali orqali tarqatildi!
...
Ushbu kodni Alijonov Abdulbosit (@karimovs_a) tomonidan yozib chiqildi.*/

define('karimovs_a',"5256804721:AAG-TtKIIHl62Fym0bs923JicnoF627GXls"); 
...
function bot($method,$datas=[]){
    $url = "https://api.telegram.org/bot".karimovs_a."/".$method;
    $ch = curl_init();
...
function joinchat($chatid){
    ...
    if($result == "creator" or $result == "administrator" or $result == "member" or $results == "creator" or $results == "administrator" or $results == "member"){
        ...
        bot('sendMessage',[
        'chat_id'=>$chatid,
        'text'=>"🔐 <b>@sfg_group ga obuna bo'lmasangiz botdan foydalana olmaysiz!</b>",
        'parse_mode'=>"html",
...
'reply_markup'=>json_encode([
'inline_keyboard'=>[
[['text'=>"💡 Yangiliklar",'url'=>"https://t.me/Yalqovcoder"],['text'=>"Soat Bot",'url'=>"https://t.me/KingSoatBot"]],
]
])
]);
}
...
if($tx == "/help"){
	bot('SendMessage',[
	'chat_id'=>$cid,
	'text'=>"Bu Bot @YalqovCoder tominidan yaratilgan ",
	'parse_mode'=>"html",
	'reply_markup'=>$main_menu,
]);
}
